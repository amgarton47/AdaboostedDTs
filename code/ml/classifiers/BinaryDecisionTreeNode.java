...
public class BinaryDecisionTreeNode {
	...
	private BinaryDecisionTreeNode left;
	private BinaryDecisionTreeNode right;
	 ...
	 */
	public BinaryDecisionTreeNode(double prediction) {
		leaf = true;
	 ...
	 * @param featureIndex
	 */
	public BinaryDecisionTreeNode(int featureIndex) {
		leaf = false;
	 ...
	 * @param node
	 */
	public void setLeft(BinaryDecisionTreeNode node) {
		this.left = node;
	}
	 ...
	 * @return
	 */
	public BinaryDecisionTreeNode getLeft() {
		return left;
	}
	 ...
	 * @param node
	 */
	public void setRight(BinaryDecisionTreeNode node) {
		this.right = node;
	}
	 ...
	 * @return
	 */
	public BinaryDecisionTreeNode getRight() {
		return right;
	}
	 ...
	 * below it. This basic version only prints out feature indices.
	 * 
	 * @return
	 */
	...
	/**
	 * Get a formatted string representation of this DecisionTreeNode and all nodes
	 * below it. This version will put in the actual feature names based on the
	 * mapping supplied.
	 * 
	 * @param featureMap
	 * @return
